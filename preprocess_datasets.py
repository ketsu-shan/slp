...
if __name__ == '__main__':
    ...
    out_path1 = '/workspace/shanshanguo/project/SPIN-master_single/data/dataset_extras/'
    openpose_path = cfg.OPENPOSE_PATH
    openpose_path1 = '/workspace/shanshanguo/project/openpose-master/output_22_slp/'
    ...
    if args.train_files:
        ...
        slp_dataset_extract(cfg.LSP_ORIGINAL_ROOT,openpose_path,out_path)
    ...
    if args.eval_files:
        ...
        #coco_extract(cfg.COCO_ROOT, openpose_path, out_path)
        slp_dataset_extract(cfg.LSP_ORIGINAL_ROOT,openpose_path1,out_path1)